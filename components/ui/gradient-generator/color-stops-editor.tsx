  ...
  <div className="space-y-3">
    ...
    <div className="grid lg:grid-cols-5 grid-cols-2 gap-3">
      {colorStops.map((stop, index) => (
        <div
          key={stop.id}
          className="flex w-full flex-col gap-4 rounded-lg border bg-background/50 p-4 sm:w-auto sm:flex-row sm:items-center sm:gap-5"
        >
          <Popover>
              ...
              <ColorPicker
                ...
                onChange={(value) => {
                  if (Array.isArray(value)) {
                    onUpdate(stop.id, convertPickerValue(value), stop.position);
                  }
                }}
          ...
          <div className="flex w-full flex-col gap-2 sm:w-auto">
            ...
            <div className="flex items-center gap-2">
              <Input
                ...
                className="h-10 w-full text-center sm:h-9 sm:w-20"
              />
          ...
          {colorStops.length > 2 && (
            <Button
              variant="ghost"
              size="icon"
              className="h-10 w-10 self-start hover:bg-destructive/10 hover:text-destructive sm:h-8 sm:w-8"
